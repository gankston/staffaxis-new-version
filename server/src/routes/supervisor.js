  ...
  app.get('/api/supervisor/pending', { preHandler: verifySupervisor }, async (req, reply) => {
    ...
    return reply.send({
      items: r.rows.map(x => ({
        ...
        cargaCamionBolsas50: x.carga_camion_bolsas_50, cargaCamionBolsas25: x.carga_camion_bolsas_25,
        cargaCamionBolsasOtro: x.carga_camion_bolsas_otro,
        movimientoEstibaBolsas50: x.movimiento_estiba_bolsas_50, movimientoEstibaBolsas25: x.movimiento_estiba_bolsas_25,
        movimientoEstibaBolsasOtro: x.movimiento_estiba_bolsas_otro,
